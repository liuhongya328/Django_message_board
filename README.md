...
#### 一、AI生成语言信息界面如下：
【功能】：输入个人信息和AI生成语言信息并提交到后台，上传到mysql数据库中。点击**提交**按钮可跳转至**AI生成语言板界面**查看自己和其他人的AI生成语言信息。
...
#### 二、AI生成语言板界面如下：
【功能】：显示当前及历史AI生成语言信息。点击**返回**按钮可返回至**AI生成语言信息界面**继续AI生成语言。
